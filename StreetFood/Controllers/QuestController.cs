...
namespace StreetFood.Controllers
{
    ...
    public class QuestController : ControllerBase
    {
        ...
        [HttpGet("user-quest-tasks")]
        [Authorize(Roles = "Admin,Moderator")]
        public async Task<IActionResult> GetUserQuestTasksByQuest([FromQuery] UserQuestTaskQueryDto query)
        {
            var result = await _questService.GetUserQuestTasksByQuestAsync(query);

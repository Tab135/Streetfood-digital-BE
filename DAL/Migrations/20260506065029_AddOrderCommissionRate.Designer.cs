...
namespace DAL.Migrations
{
    ...
    [Migration("20260506065029_AddOrderCommissionRate")]
    partial class AddOrderCommissionRate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BO.Entities.Campaign", b =>
                {
                    ...
                    b.Property<int?>("ExpectedBranchJoin")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BO.Entities.CurrentPickBranch", b =>
                {
                    b.Property<int>("CurrentPickBranchId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("CurrentPickBranchId"));
                    ...
                    b.HasKey("CurrentPickBranchId");

                    b.HasIndex("AddedByUserId");

                    b.HasIndex("BranchId");

                    b.HasIndex("CurrentPickRoomId", "BranchId")
                        .IsUnique();
            ...
            modelBuilder.Entity("BO.Entities.CurrentPickMember", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("CurrentPickMemberId"));
                    ...
                    b.HasKey("CurrentPickMemberId");

                    b.HasIndex("UserId");

                    b.HasIndex("CurrentPickRoomId", "UserId")
                        .IsUnique();

                    b.ToTable("CurrentPickMembers");
                });
            ...
            modelBuilder.Entity("BO.Entities.CurrentPickRoom", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("CurrentPickRoomId"));
                    ...
                    b.Property<int?>("FinalizedBranchId")
                        .HasColumnType("integer");
                    ...
                    b.HasKey("CurrentPickRoomId");

                    b.HasIndex("FinalizedBranchId");
                    ...
                    b.ToTable("CurrentPickRooms");
                });

            modelBuilder.Entity("BO.Entities.CurrentPickVote", b =>
                {
                    b.Property<int>("CurrentPickVoteId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("CurrentPickVoteId"));
            ...
            modelBuilder.Entity("BO.Entities.Setting", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 9,
                            Name = "feedbackDailyLimit",
                            Value = "3"
                        },
                        new
                        {
                            Id = 10,
                            Name = "VendorOrderCommissionPercent",
                            Value = "10"
                        });
                });
            ...
            modelBuilder.Entity("BO.Entities.BranchRequest", b =>
                {
                    ...
                    b.HasOne("BO.Entities.User", "RequestedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("BO.Entities.CurrentPickBranch", b =>
                {
                    b.HasOne("BO.Entities.User", "AddedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("BO.Entities.CurrentPickRoom", b =>
                {
                    b.HasOne("BO.Entities.Branch", "FinalizedBranch")
                        .WithMany()
                        .HasForeignKey("FinalizedBranchId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("BO.Entities.User", "HostUser")
                        .WithMany()
                        .HasForeignKey("HostUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("FinalizedBranch");
            ...
            modelBuilder.Entity("BO.Entities.Order", b =>
                {
                    b.HasOne("BO.Entities.Voucher", "AppliedVoucher")
                        .WithMany()

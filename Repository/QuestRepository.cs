...
namespace Repository
{
    public class QuestRepository : IQuestRepository
    {
        ...
        public Task<bool> HasActiveTierUpQuestForTierAsync(int tierId, int? excludeQuestId = null) => _dao.HasActiveTierUpQuestForTierAsync(tierId, excludeQuestId);
        public Task<Quest?> GetActiveTierUpQuestForTierAsync(int tierId) => _dao.GetActiveTierUpQuestForTierAsync(tierId);

...
namespace Repository
{
    public class UserQuestRepository : IUserQuestRepository
    {
        ...
        public Task<(List<UserQuestTask> Items, int TotalCount)> GetUserQuestTasksByQuestAsync(int questId, UserQuestTaskQueryDto query) => _dao.GetUserQuestTasksByQuestAsync(questId, query);
